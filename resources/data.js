! function () {
    ...
    function c() {
        d3.select(".datamaps-style-block").empty() && d3.select("head").attr("class", "datamaps-style-block").append("style").html('.datamap path {stroke: #FFFFFF; stroke-width: 1px;} .datamaps-legend dt, .datamaps-legend dd { float: left; margin: 0 3px 0 0;} .datamaps-legend dd {width: 20px; margin-right: 6px; border-radius: 3px;} .datamaps-legend {padding-bottom: 20px; z-index: 1001; position: absolute; left: 4px; font-size: 12px; font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;} .datamaps-hoverover {display: none; font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; } .hoverinfo {padding: 4px; border-radius: 1px; background-color: #FFF; box-shadow: 1px 1px 5px #CCC; font-size: 12px; border: 1px solid #CCC; } .hoverinfo hr {border:1px dotted #CCC; }')
    }

    function d(a) {
        var b = this.options.fills,
            c = this.options.data || {}, d = this.options.geographyConfig,
    ...
    function e() {
        ...
        (d.highlightOnHover || d.popupOnHover) && b.selectAll(".datamaps-subunit").on("mousedown", function (e) {
                ...
                if (d.highlightOnHover) {
                    ...
                    f.style("fill", d.highlightFillColor).style("stroke", d.highlightBorderColor).style("stroke-width", d.highlightBorderWidth).style("fill-opacity", d.highlightFillOpacity).attr("data-previousAttributes", JSON.stringify(g)), /MSIE/.test(navigator.userAgent) || a.call(this)
                }
    ...
    function g(a, b, c) {
        ...
        "undefined" == typeof c && (c = l.arcConfig);
        var e = a.selectAll("path.datamaps-arc").data(b, JSON.stringify);
        e.enter().append("svg:path").attr("class", "datamaps-arc").style("stroke-linecap", "round").style("stroke", function (a) {
            return a.options && a.options.strokeColor ? a.options.strokeColor : c.strokeColor
        }).style("fill", "none").style("stroke-width", function (a) {
        ...
        }), e.exit().transition().style("opacity", 0).remove()
    }
    ...
    function k(b) {
        ...
        return this.options = j(b, l), this.options.geographyConfig = j(b.geographyConfig, l.geographyConfig), this.options.bubblesConfig = j(b.bubblesConfig, l.bubblesConfig), this.options.arcConfig = j(b.arcConfig, l.arcConfig), d3.select(this.options.element).select("svg").length > 0 && a.call(this, this.options.element), this.addPlugin("bubbles", i), this.addPlugin("legend", f), this.addPlugin("arc", g), this.addPlugin("labels", h), this.options.disableDefaultStyles || c(), this.draw()
    }
    var l = {
        scope: "world",
        setProjection: b,
    ...
    k.prototype.draw = function () {
        function a(a) {
            d.call(b, a), e.call(b), (b.options.geographyConfig.popupOnHover || b.options.bubblesConfig.popupOnHover) && (hoverover = d3.select(b.options.element).append("div").attr("class", "datamaps-hoverover").style("z-index", 10001).style("position", "absolute")), b.options.done(b)
        }
        var b = this,
            c = b.options,
        ...
        objects: {
            world: {
                ...
                geometries: [{
                    ...
                    id: "COD",
                    arcs: [
                        [196, 197, -60, 198, 199, -10, 200, -12, 201, -126, 202]
                    ],
                    properties: {
                    ...
                    id: "DEU",
                    arcs: [
                        [222, 223, -220, -52, -164, 224, 225, -63, 226, 227, 228]
                    ],
                    properties: {
                        name: "Germany"
                    }
                    ...
                    arcs: [
                        ...
                        [
                            [281, -225, -163, 282, 283, -257, 284, -65]
                        ]
                    ],
                    properties: {
                        name: "France"
                    ...
                    id: "IRN",
                    arcs: [
                        [-6, 354, 355, 356, 357, -55, -33, -57, 358, 359]
                    ],
                    properties: {
                        name: "Iran"
                    }
                    ...
                    arcs: [
                        ...
                        [
                            [-505, -184, -445, -182, -389, 523, -59, -292, 524, 525, -95, -428, -261, 526, -269, -473, 527]
                        ],
                        [
                            [528]
                        ],
                    ...
                    id: "SAU",
                    arcs: [
                        [534, -380, -362, -408, 535, -510, 536, -23, -482, 537]
                    ],
                    properties: {
                        name: "Saudi Arabia"
                    }
                    ...
                    id: "SDN",
                    arcs: [
                        [-123, 538, -419, -249, 539, -254, -268, 540, 541, 542]
                    ],
                    properties: {
                        name: "Sudan"
                    }
                    ...
                    id: "SDS",
                    arcs: [
                        [-266, -394, 543, -203, -125, 544, -542, 545]
                    ],
                    properties: {
                        name: "South Sudan"
                    }
                    ...
                    id: "TZA",
                    arcs: [
                        [-392, 579, -446, -458, 580, -199, -62, -532, 581]
                    ],
                    properties: {
                    ...
                    id: "UKR",
                    arcs: [
                        [-526, 582, -512, -431, -511, -330, -562, -502, -96]
                    ],
                    properties: {
                        name: "Ukraine"
                    }
        ...
        for (var c in a)
            if (a.hasOwnProperty(c)) {
                var d;
                d = "string" == typeof a[c] ? a[c] : "string" == typeof a[c].color ? a[c].color : this.options.fills[a[c].fillKey], b.selectAll("." + c).transition().style("fill", d)
            }
    }, k.prototype.updatePopup = function (a, b, c) {
        var d = this;
        a.on("mousedown", null), a.on("mouseup", function () {
            var e = d3.mouse(this);
        ...
        "undefined" == typeof k.prototype[a] && (k.prototype[a] = function (c, d, e, f) {
            var g;
            "undefined" == typeof f && (f = !1), "function" == typeof d && (e = d, d = void 0), d = j(d || {}, l[a + "Config"]), !f && this.options[a + "Layer"] ? (g = this.options[a + "Layer"], d = d || this.options[a + "Options"]) : (g = this.addLayer(a), this.options[a + "Layer"] = g, this.options[a + "Options"] = d), b.apply(this, [g, c, d]), e && e(g)
        })
